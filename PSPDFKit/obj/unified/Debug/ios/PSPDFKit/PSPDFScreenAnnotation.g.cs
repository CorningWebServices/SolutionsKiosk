...
namespace PSPDFKit {
	...
	public unsafe partial class PSPDFScreenAnnotation : PSPDFLinkAnnotation, IPSPDFStreamProvider {
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected PSPDFScreenAnnotation (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal PSPDFScreenAnnotation (IntPtr handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		public virtual PSPDFMediaScreenWindowType MediaScreenWindowType {
			[Export ("mediaScreenWindowType", ArgumentSemantic.UnsafeUnretained)]
			get {
				PSPDFMediaScreenWindowType ret;
				if (IsDirectBinding) {
					if (IntPtr.Size == 8) {
						ret = (PSPDFMediaScreenWindowType) global::ApiDefinition.Messaging.UInt64_objc_msgSend (this.Handle, Selector.GetHandle ("mediaScreenWindowType"));
					} else {
						ret = (PSPDFMediaScreenWindowType) global::ApiDefinition.Messaging.UInt32_objc_msgSend (this.Handle, Selector.GetHandle ("mediaScreenWindowType"));
					}
				} else {
					if (IntPtr.Size == 8) {
						ret = (PSPDFMediaScreenWindowType) global::ApiDefinition.Messaging.UInt64_objc_msgSendSuper (this.SuperHandle, Selector.GetHandle ("mediaScreenWindowType"));
					} else {
						ret = (PSPDFMediaScreenWindowType) global::ApiDefinition.Messaging.UInt32_objc_msgSendSuper (this.SuperHandle, Selector.GetHandle ("mediaScreenWindowType"));
					}
				}
				return ret;
			}
